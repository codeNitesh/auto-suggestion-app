...
function App() {
  ...
  const suggestion = [
    ...
    },
    {
      ...
      "designation": {
        ...
        "department": "Development",
        "responsibilities": [
          "Building and maintaining end-to-end web applications",
    ...
    },
    {
      ...
      "designation": {
        ...
        "skills": [
          "Design tools (e.g., Sketch, Adobe XD)",
          "User research and usability testing",
          "Front-end technologies (e.g., HTML, CSS)"
        ]
      }
    },
    {
  ...
  return (
    <div className='main-body'>
      <AutoSuggestion suggestion={suggestion} />
    </div>
